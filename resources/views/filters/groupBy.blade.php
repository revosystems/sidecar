@if ($report->availableGroupings()->count() > 0)
    <div class="sidecar-group-by w-full">
        <x-ui::forms.multiple-select id="sidecar-groupby" name="groupBy[]" placeholder="{{__(config('sidecar.translationsPrefix').'groupBy') }}..." class="w-full">
